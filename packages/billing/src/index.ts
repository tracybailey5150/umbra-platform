...
export const PLANS: Record<PlanSlug, PlanDefinition> = {
  quote_agent_starter: {
    ...
    monthlyFeeMax: null,
    displayPrice: "$349/mo",
    displaySetup: "$2,500 setup",
    isEnterprise: false,
    highlights: [
      "1 Quote Agent",
      "Up to 200 submissions/mo",
      "AI summaries & structured extraction",
  ...
  quote_agent_pro: {
    ...
    monthlyFeeMax: null,
    displayPrice: "$749/mo",
    displaySetup: "$5,000 setup",
    isEnterprise: false,
    highlights: [
      "Up to 5 Quote Agents",
      "Unlimited submissions",
      "AI summaries, extraction & follow-up",
      "Custom branding on intake forms",
      "Advanced analytics",
      "10 team members",
      "API access",
    ],
